...
<body>
   <div class="navbar-wrapper">
    ...
    <div id="myCarousel" class="carousel slide">
      <div class="carousel-inner">
        ...
        <div class="item">
          ...
          <img src="images/tech-nokia.jpg" alt="Second Slide">
          <div class="container">
    ...
    <div class = "container">
        ...
        <a href = "${pageContext.request.contextPath}/phones?category=phone" class="thumbnail">
        <img src="<c:url value="/resources/images/phone-hover.jpg"/>">
       
            </a>
        </div>
        <div class = "col-xs-3" id="accessories">
        <h4>Buy Accessories</h4>
        <a href = "${pageContext.request.contextPath}/Buy Accesories" class="thumbnail">
        <img src="<c:url value="/resources/images/cell-phone-accessories.jpg"/>">
        </a>
        </div>
        <div class = "col-xs-4" id= "tab">
         <h4>Buy Tablets</h4>
        <a href = "${pageContext.request.contextPath}/tablets?category=tablets" class="thumbnail">
        <img src="<c:url value="/resources/images/tablets-montage.jpg"/>">
        </a>
        </div>
        </div>
